...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
    ...
    data[0] = (rawData[0] | rawData[1]);
    data[1] = (rawData[2] | rawData[3]);
    data[2] = (rawData[4] | rawData[5]);
    data[3] = (rawData[6] | rawData[7]);
    data[4] = (rawData[8] | rawData[9]);
    data[5] = (rawData[10] | rawData[11]);
    data[6] = (rawData[12] | rawData[13]);
